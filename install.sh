...
#
#   curl -fsSL https://cdn.quickflo.app/packages/cli/install.sh | sh                       # latest
#   curl -fsSL https://cdn.quickflo.app/packages/cli/install.sh | sh -s v1.0.2              # pin a version
...
DEFAULT_BASE="https://cdn.quickflo.app/packages/cli"
